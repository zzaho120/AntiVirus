...
public class Main : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        EquippableTable equippableTable = DataTableMgr.GetTable<EquippableTable>();
        ItemTable itemTable = DataTableMgr.GetTable<ItemTable>();
        CharacterTable chracterTable = DataTableMgr.GetTable<CharacterTable>();
